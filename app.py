...
def track_room_presence():
    ...
    # ── Home screen display settings ───────────────────────────────────────────
    # home_show_featured: 1/0  home_show_slides: 1/0  home_slides_style: full/side
    home_defaults = [
        ('home_show_featured', '1'),
        ('home_show_slides',   '1'),
        ('home_slides_style',  'full'),
...
def import_m3u():
    ...
    if request.content_type and 'multipart' in request.content_type:
        ...
        max_ch       = int(request.form.get('max_channels', 0) or 0)
...
def vod_upload_video():
    ...
    nx_id     = int(request.form.get('nexvision_id', 0) or 0)
